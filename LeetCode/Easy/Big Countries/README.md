...
| **Tags** | Database |
| **Link** | [View Problem](https://leetcode.com/problems/big-countries/) |
| **Runtime** | 64 ms |
| **Memory** | 0B |
...
**Author**: [@GANJINAVEEN](https://leetcode.com/GANJINAVEEN/)
**Upvotes**: 88 👍
**Link**: [View Original Post](https://leetcode.com/problems/big-countries/solutions/3362481/)
